colorImage = imread('C:\Users\Tharaka\Desktop\Dip_Project\text18.jpg');
...
fid = fopen('C:\Users\Tharaka\Desktop\abcd.txt','w+');
fprintf(fid, '%s\n', xyz);
fclose(fid)
...
subplot(1,2,2);
imshow(ITextRegion);
text(end, end,recognizedText , 'BackgroundColor', [1 1 1]);
title('text');
